    ...
    <div>
      <div className="container max-w-4xl mx-auto mt-4 px-4 p-6 bg-white">
        ...
        <div className="profile-picture">
          ...
          {!isUploadSelected ? (
            <Button onClick={handleUploadPicture}>Profilkép feltöltése</Button>
          ) : (
            <div className="upload-image">
              ...
              <div className="upload-image-buttons">
                <Button className="save-button" onClick={handleUploadPicture}>
                  ment
                </Button>
                <Button onClick={() => setIsUploadSelected(false)}>
                  Mégse
                </Button>
              </div>
            </div>
